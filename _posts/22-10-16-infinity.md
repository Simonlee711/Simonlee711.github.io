...
This is a hard read because it is technical but I tried to explain it as simply as possible. I also think this is one of the most interesting blog posts so even if it's hard and long, I recommend you read through the whole thing.
...
If you add an infinite sequence of this given equation you will always end up at one. If you have ever taken Calculus, you should be able to detect that this is a convergent series. Meaning that adding an infinite amount of numbers will sum to a finite number. However, let's look at its counterpart: divergent series. If we add the following we should get infinity:
 
\\[ 1 + 2 + 3 + 4 ... + n = \infty \\]
 
Now let's take it a step further by taking our sum and adding 1 to it. We should get some sequence like this
...
Space is believed to be infinite. However, observable space or the couple galaxies that we know exist is a finite dimensional space. And if we were to view this finite dimensional space as a composition of extremely tiny cubic voxels, there is a finite amount of voxels that compose our "universe". Now let's say there were special states or orientations our universe could be in. This idea puts a finite constraint on the amount of permutation designs our universe can take form as. Therefore within the finite dimensions we know (observable space), there is a limitation of what our universe can look like. So what could possibly make space infinite?
...
Now to those who do not believe me about the maximum value at which a thing can travel, I will present another example of the speed of light in action. The stars we see at night are miniscule in size because they are billions of light years away from the Earth. And so every night when we see the stars these are image projections of where the planet was in the past. Because that star's light traveled a billion light years in distance, by the time it reaches you, that star is definitely in a much farther position in space. Isn't that a crazy thought in itself. Everything we see in the night sky, if far enough, is just a past projection of where that star, comet, planet was light years before. It is simply because light travels at a constant 299 792 458 meters/sec that it took us so long for us to be able to perceive it.
...
Now that we know that light is the fastest thing in our universe and even that is too slow, what does that really make of us? If the universe is indeed infinite, why even bother trying to explore other possible exo-planets that humans can inhabit. As someone who was a big supporter of space exploration as a kid, it also makes me wonder that this may be one of the most useless uses of our funds if they are not within a reachable point (i.e. our solar system). Even then, to get to Mars, or Jupiter's moon, Europa, it would just take an incredible amount of time that is not worth it in the end.
 
This loss of hope in space exploration and trying to expand human beings to be multi-terrestrial raises the question: *Does anything matter?* All the damage that humans have caused on Earth is pretty irreversible and what has been done to preserve mother Earth.On the contrary, we are also just specks in this infinite universe that are living in an extremely short finite time interval. *So what is it that we are trying to accomplish in our lives while we are here?* This is where thinking too hard can lead to a downward spiral. If you think in logical terms, there truly is no purpose to our lives but I think humans have been able to add purpose to this meaningless world.
 
As complex as the world is, humans are just as complex, and for me personally, I am swayed by emotions. Perhaps I can feel sentiment or anger or happiness towards something and that is what makes life the way it is. We can go down all these loopholes about determining whether death is infinite, or if God is actually the concept of infinity, but we will save those for another time. However, I briefly wanted to talk about whether love is infinite? This may be a physical thing in our world that is an observable infinity. To me personally, I want to believe it is but is it possible to love someone for the whole duration of your life?  Through my short life, I have held onto a few friends for extended periods of times and I have met people that I want to love forever, but I guess this idea of whether love is infinite is subjective from person to person. So to answer it in my perspective, only time will tell.
 
So let's go back to the theoretical side of things and ask what if we went in one direction infinitely forever. Truth is just like the earth, physicists believe the universe is some spherical shape. Therefore if we went in one direction for an infinite amount of time, then we would end up at the same place we started. However physicists also believe that the shape of the universe is expanding at an accelerating rate which means that our galaxies are actually repulsing against one another. What this means for us is absolutely nothing but in the grand scheme of the feasible spacial domain, this may mean the timeline of life in the universe is finite. There will always exist a universe but life as we know it may cease to exist (predicted in 100 billion years). So life is just like us and it is living in a short time interval that won't last forever. This makes life's history short and infinity that much larger.
 
---
 
# So what
 
Truth is no one should care. A lot of the theoretical physics and mathematics is being done is purely to understand the universe we live in. I will conclude with one last thought. Are humans infinite? Will there be an infinite variation of human beings for the next 100 billion years? The answer is probably not but there is no way to compare human beings due to their short life spans. However I have reached this argument because like the observable universe our brains can only hold so many neurons. And these neurons can be intertwined in an exponential amount of ways but this number is likely to still be finite. So based on everything that was discussed in this blog post, I believe that due to the finite amount of permutations of our brains, humans themselves also cannot be infinite.
